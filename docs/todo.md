...
- `docs/features.md` §7 — trigger-gated candidates. No-signal picks have
  been done out-of-queue three times: on 2026-09-12 (iteration 13) the
  ...
  days in `dailyBonus.ts`), and on 2026-09 (iteration 15) the pass-17
  ...
  retention research). The rest stays
