...
- ⬜ Cave themes (tier 4), endgame (tier 5) — `goals.ts` lists them as "(coming soon)" unlocks; each lands when implemented. (Prestige/New Shaft, tier 3, shipped — see below.)
...
- ⬜ Remaining gem uses (click ×2, combo resistance, …) — gem-chance +% shipped above with tier 2.
