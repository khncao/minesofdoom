...
- [ ] Add plain names for operators in settings
- [ ] Add alt display for other operations besides multiplication as well
- [ ] Remove streak mode and timed mode settings
- [ ] Save user's randomized look
