...
const PRIVACY_POLICY: LegalDoc = {
  ...
  sections: [
    ...
    },
    {
      heading: "Deletion",
      body:
        "Local game data: Settings → Reset (device data and local stats/crash log can be cleared individually in Settings). Account data (account, cloud save, leaderboard entries): email us with the address you signed up with and it will be deleted, including the database and backups. Data that Google or Apple hold on your behalf is managed by their own settings and policies.",
    },
    {
