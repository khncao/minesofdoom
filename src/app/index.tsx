import MinesOfDoom from "src/mines_of_doom/MinesOfDoom";
import ErrorBoundary from "src/mines_of_doom/components/ErrorBoundary";
import { useGlobalCrashCapture } from "src/mines_of_doom/hooks/useGlobalCrashCapture";
